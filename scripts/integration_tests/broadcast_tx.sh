...
simd tx bank send  $(simd keys show jack -a --keyring-backend test) $(simd keys show alice -a --keyring-backend test) 50000000stake --chain-id=test_chain --from jack --broadcast-mode sync --keyring-backend test -y
sleep 20s
